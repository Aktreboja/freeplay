...
const goToGames = (category: string) => {
...
<template>
  <section>
    <main class="section" style="height: 100vh">
      ...
      <p style="margin-bottom: 10px" class="primary-base text-sm">Powered by the FreetoGame API</p>
      <div>
        <Button
          severity="Secondary"
          text
